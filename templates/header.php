        ...
        <ul class="sidebar-nav">
            ...
            <li>
                ...
                <ul id="sidebar-ui" class="collapse">
                    <li><a href="ui_components.php">Components</a></li>
                    <li><a href="ui_notifications.php">Notifications</a></li>
                    <li><a href="ui_icons.php">Icons</a></li>
                    <li><a href="ui_buttons.php">Buttons</a></li>
                    <li><a href="ui_tabs_accordion.php">Tabs & Accordion</a></li>
                    <li><a href="ui_list_groups.php">List Groups</a></li>
                </ul>
            </li>
            <li>
                <a href="grid.php">
            ...
            <li>
                ...
                <ul id="sidebar-tables" class="collapse">
                    <li><a href="tables_basic.php">Tables Basic</a></li>
                    <li><a href="tables_dynamic.php">Tables Dynamic</a></li>
                </ul>
            </li>
            <li>
                ...
                <ul id="sidebar-extra" class="collapse">
                    ...
                    <li><a href="login.php" target="_blank" data-no-pjax>Login Page</a></li>
                    <li><a href="error.php" target="_blank" data-no-pjax>Error Page</a></li>
                    <li><a href="gallery.php">Gallery</a></li>
                    <li><a href="search.php">Search Results</a></li>
                    <li><a href="time_line.php" data-no-pjax>Time Line</a></li>
                </ul>
            </li>
            <li>
