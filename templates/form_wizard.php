                                    ...
                                    <div class="tab-content">
                                        ...
                                        <ul class="pager wizard">
                                            ...
                                            <li class="finish" style="display: none">
                                                <button class="btn btn-success btn-rounded pull-xs-right" >
                      ...
                      Lookup
                                    ...
                                    <div class="wizard-card wizard-card-overlay" data-cardname="services">
                                        ...
                                        <div class="wizard-input-section">
                                            ...
                                            <select name="services" data-placeholder="Service List" style="width:350px;" class="chzn-select create-server-service-list" multiple>
