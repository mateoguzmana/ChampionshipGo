...
<html>
<head>
    <title>Sing - Form Elements</title>
                        ...
                        <form class="form-horizontal" role="form">
                            <fieldset>
                                ...
                                <div class="form-group row">
                                    <label for="normal-field" class="col-md-4 form-control-label text-md-right">Normal field</label>
                                    <div class="col-md-7">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 control-label text-md-right" for="tooltip-enabled">Tooltip enabled</label>
                                    <div class="col-md-7">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 control-label text-md-right" for="disabled-input">Disabled input</label>
                                    <div class="col-md-7">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 control-label text-md-right" for="prepended-input">Prepended input</label>
                                    <div class="col-md-7">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 control-label text-md-right" for="password-field">Password</label>
                                    <div class="col-md-7">
                                        <div class="input-group">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 control-label text-md-right" for="appended-input">Appended input</label>
                                    <div class="col-md-7">
                                        <div class="input-group">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 control-label text-md-right" for="combined-input">Combined</label>
                                    <div class="col-md-7">
                                        <div class="input-group">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 control-label text-md-right" for="transparent-input">
                                        Append Transparent
                                    </label>
                                    <div class="col-md-7">
                    ...
                    <div class="widget-body">
                        <form class="form-horizontal" role="form">
                            <fieldset>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 control-label text-md-right" for="default-textarea">Default textarea</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="btn-toolbar">
                                            <button type="button" class="btn btn-sm btn-secondary pull-xs-right">Clear</button>
                                            <button type="button" class="btn btn-sm btn-danger pull-xs-right">Save</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
